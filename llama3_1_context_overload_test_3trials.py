...
CSV_FILENAME = "llama3_1_context_overload_results_3trials.csv"
RAW_OUTPUT_DIR = Path("llama3_1_raw_outputs_3trials")
...
with open(CSV_FILENAME, mode="w", newline="", encoding="utf-8") as file:
    ...
    print("Starting Llama 3.1 context-overload experiment")
    ...
    for trial in range(1, NUM_TRIALS + 1):
        ...
        for target_words in context_lengths:
            ...
            try:
                ...
                raw_file = RAW_OUTPUT_DIR / f"llama3_1_trial_{trial}_output_{target_words}_words.txt"
...
print("Llama 3.1 context-overload experiment complete.")
