...
CSV_FILENAME = "qwen3_position_ablation_results_3trials.csv"
RAW_OUTPUT_DIR = Path("qwen3_position_raw_outputs_3trials")
...
with open(CSV_FILENAME, mode="w", newline="", encoding="utf-8") as file:
    ...
    print(f"Starting Qwen position ablation study")
    ...
    for trial in range(1, NUM_TRIALS + 1):
        ...
        for pos in positions:
            ...
            try:
                ...
                raw_file = RAW_OUTPUT_DIR / f"qwen3_trial{trial}_position_{pos.lower()}_{target_words}_words.txt"
...
print("Qwen position ablation study complete.")